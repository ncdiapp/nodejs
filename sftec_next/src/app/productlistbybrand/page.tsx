...
const ProductListByBrand = async({ params, searchParams }: any) => {
  ...
  const dataModel: { [key: string]: any } = appHelper.initializePageDataModel('ProductListByBrand', params, searchParams, headersList);
  ...
  metadata.title = `ProductListByBrand`;
  /*** End of metadata.title ***/

  /*** Start of metadata.description ***/
  metadata.description = `ProductListByBrand`;
  /*** End of metadata.description ***/

  /*** Start of metadata.keywords ***/
  metadata.keywords = `ProductListByBrand`;
